  ...
  return (
    <div className="h-20 bg-background-elevated border-t border-background-highlight px-6 flex items-center">
      <div className="w-1/4 flex items-center">
        ...
        />
        <div>
          <h4 className="text-sm font-medium cursor-pointer">{currentTrack.title}</h4>
      ...
      <div className="w-2/4 flex flex-col items-center">
        <div className="flex items-center mb-3">
          <button className="iconbtn text-text-secondary hover:text-white mx-2 cursor-pointer">
            <SkipPreviousIcon />
          </button>
          <button
